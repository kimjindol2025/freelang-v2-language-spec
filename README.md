...
| 문서 | 설명 |
|------|------|
| **LANGUAGE_POLICY.md** | 언어 철학, 설계 원칙, 운영 정책 |
| **VM_ARCHITECTURE.md** | VM 내부 구조, 메모리/네트워크/DB 모듈 |
| **TYPE_SYSTEM.md** | 자료형, 타입 안전성, 변환 규칙 |
| **STDLIB_MODULES.md** | 표준 라이브러리 모듈 목록 |
| **EXAMPLES/** | 샘플 코드 (메모리, 네트워크, DB, 통합) |
...
| **@freelang/http** | 12001 | HTTP 서버 모듈 |
| **@freelang/network** | 12002 | 네트워크 모듈 |
| **@freelang/socket** | 12003 | 소켓 저수준 제어 |
| **@freelang/server** | 12004 | 웹 서버 프레임워크 |
